...
data = { # Objeto JSON enviado a random.org para solicitar los numeros aleatorios
    ...
    "params": {
        "apiKey": "30791efd-b217-4a09-91ed-acfff997f163", # API Key generada para un usuario de random.org. Es gratis.
        "n": n, # Cantidad de numeros solicitados
        "min": 0, # Numero minimo
        "max": 8987, # Numero maximo
        "replacement": True
    },
    "id": 42
}
...
numeros = my_data_array 
print(numeros)

numeros=numeros/8987
print(numeros)

#Menu
def menu():
	print ("Selecciona una opción")
	print ("\t1 - Test Chi Cuadrado Random.org")
	print ("\t2 - Test de Corridas Arriba-Abajo de la Media Random.org")
	print ("\t3 - Test Autocorrelación Random.org")
	print ("\t4- Test Smirnov Random.org")
